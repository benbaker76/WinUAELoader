...
namespace WinUAELoader
{
    ...
    class KeyCodes
    {
        ...
        public static int VK2Amiga(int vk)
        {
            for (int i = 0; i < AmigaInput.AmigaDefaultKeys.Length; i++)
                if (DIK2VK(AmigaInput.AmigaDefaultKeys[i].DIKKey) == vk)
                    return AmigaInput.AmigaKeyHash[AmigaInput.AmigaDefaultKeys[i].Name].Data;
